class stadion {
    constructor(name, city, district, metro, adress, price, floor, cover, size, bath, cafe, video, park, img1, img2, img3) {
        this.name = name;
        this.city = city;
...
//firebase 2 declare olunmasi
var secondData = otherProject.database().ref();


// index.html ucun filter/axtaris funksiyasi ve stadiums.html sehifesine datalarin aparilmasi
function axtaris() {
...
//firebase 2 melumatlarin goturulmesi
var dataVal;
var sentVal;
var sentKey;
var qlavniArr = []
secondData.on('value', function (callback) {
    dataVal = callback.val();
    sentKey = Object.keys(dataVal);
    sentVal = Object.values(dataVal);
    // console.log(sentVal[Object.keys(sentVal)])
    qlavniArr = sentVal[Object.keys(sentVal)]
    // console.log(qlavniArr)
    document.getElementById("cardsarea").innerHTML = ""
    if (qlavniArr.length != 0) {
...
// stadiums.html sehifesinin cardlar ile doldurulmasi / Navbar ile stadiums sehifesine gederken
...
// stadiums.html ucun filter/axtaris funksiyasi
function axtaris2() {
    document.getElementById("cardsarea").innerHTML = ""
